...
public class ReturnBook extends javax.swing.JFrame {
    ...
    public void getIssueBookDetails(){
       ...
       int  studentId = Integer.parseInt(txt_bookId.getText());
        ...
        try{
            ...
            PreparedStatement pst = con.prepareStatement("select * from issue_book_details where book_id = ? and student_id =? "
                    + "and status = ?");
            pst.setInt(1,bookId);
    ...
    private void initComponents() {
        ...
        jPanel3.add(lbl_bookName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 370, 160, 30));
        ...
        jPanel3.add(lbl_issueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 490, 170, 30));
        ...
        jPanel3.add(lbl_issueId, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 300, 170, 30));

        jLabel19.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Student Name:");
        jPanel3.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 440, 120, -1));

        lbl_studentName.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        lbl_studentName.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(lbl_studentName, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, 170, 30));

        jLabel21.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(255, 255, 255));
        jLabel21.setText("Issue Date");
        jPanel3.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 500, 100, -1));

        lbl_bookError.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        lbl_bookError.setForeground(new java.awt.Color(255, 255, 0));
        jPanel3.add(lbl_bookError, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 610, 210, 30));

        lbl_dueDate.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        lbl_dueDate.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(lbl_dueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 560, 160, 30));

        jLabel22.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("Due Date");
        jPanel3.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 560, 100, -1));

        panel_main.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 380, 660));
        ...
        panel_main.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 110, 180, -1));
        ...
        panel_main.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 200, 260, 5));
        ...
        panel_main.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 0, 30, 30));
        ...
        panel_main.add(txt_bookId, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 270, 270, 30));
        ...
        panel_main.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 270, 160, -1));
        ...
        panel_main.add(txt_studentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 360, 270, 30));
        ...
        panel_main.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 370, 160, -1));
        ...
        panel_main.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 490, 290, 50));
        ...
        panel_main.add(rSMaterialButtonCircle3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 570, 290, 50));

        getContentPane().add(panel_main, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1300, 660));

        setSize(new java.awt.Dimension(1004, 660));
